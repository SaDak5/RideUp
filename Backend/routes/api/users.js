...
res.status(200).send({ status: "ok", msg: "Successfully registered",
token, user });
}
);
})
...
router.get('/all', async (req, res) => {
    ...
    res.status(500).json({ message: 'Erreur lors de la récupération desutilisateurs', error });
    }
    });
...
router.put('/:id', async (req, res) => {
    ...
    res.status(500).json({ message: 'Erreur lors de la mise à jour del\'utilisateur', error });
    }
    });
...
router.delete('/:id', async (req, res) => {
    ...
    res.status(500).json({ message: 'Erreur lors de la suppression del\'utilisateur', error });
    }
    });
